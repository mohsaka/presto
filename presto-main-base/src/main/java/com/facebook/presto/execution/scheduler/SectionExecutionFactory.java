...
public class SectionExecutionFactory
{
            ...
            CTEMaterializationTracker cteMaterializationTracker)
    {
        ...
        // DEBUG: Log split source information
        System.out.println("\n=== SectionExecutionFactory.createStageScheduler DEBUG ===");
        System.out.println("Stage ID: " + stageId);
        System.out.println("Fragment ID: " + plan.getFragment().getId());
        System.out.println("Partitioning Handle: " + partitioningHandle);
        System.out.println("Split Sources Count: " + splitSources.size());
        ...
        System.out.println("Fragment Root: " + plan.getFragment().getRoot().getClass().getSimpleName());
        System.out.println("==========================================================\n");
