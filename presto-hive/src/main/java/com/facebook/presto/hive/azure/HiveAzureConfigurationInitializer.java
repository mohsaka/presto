        ...
        implements AzureConfigurationInitializer
{
    ...
    public void updateConfiguration(Configuration config)
    {
        ...
        if (abfsOAuthClientEndpoint.isPresent() && abfsOAuthClientId.isPresent() && abfsOAuthClientSecret.isPresent()) {
            ...
            config.set(format("fs.azure.account.oauth.provider.type.%s.dfs.core.windows.net", abfsStorageAccount.get()), "org.apache.hadoop.fs.azurebfs.oauth2.ClientCredsTokenProvider");
